...
function mymenu() {
 ...
 $("body").after("<table  border=0px id=\"mytablejs\">\
<tbody>\
<tr>\
...
<ul id=\"listochek2\" class='listochek'>\
  ...
  <ul id=\"addnewsub2\" class='addnewsub'>\
   ...
   <li><a  onclick=\"kakulechka(((prompt('Сюда вставить номера заявок сразу из Excel')).split(/\\r?\\n+/)).slice(0, -1))\">Подтянуть сервисы к номерам заявок</a></li>\
   <li><a  onclick=\"totfinakslascalc(((prompt('Сюда вставить номера договоров сразу из Excel')).split(/\\r?\\n+/)).slice(0, -1), 1)\">Количество финаккаунтов в договорах</a></li>\
  </ul>\
</ul>\
</td>\
<td class='mystylecsstd'><a onclick=\"opennext(1)\">Open Task</a></td>\
...
<ul id=\"listochek3\" class='listochek'>\
  ...
  <ul id=\"addnewsub3\" class='addnewsub'>\
   <li><a  onclick=\"performsubscriptionaction(\'firstActivation\')\">First activation</a></li>\
   <li><a  onclick=\"performsubscriptionaction(\'vtvActivation\')\">VTVActivation </a></li>\
   <li><a  onclick=\"performsubscriptionaction(\'reactivation\')\">ReActivation</a></li>\
   <li><a  onclick=\"performsubscriptionaction(\'recrnds\')\">Recreate NDS</a></li>\
   <li><a  onclick=\"performsubscriptionaction(\'reautorise\')\">Reautorise all service</a></li>\
...
<td class='mystylecsstd'>\
<ul id=\"listochek3\" class='listochek'>\
  <li><a>Orders <input class=\"helper\" id='assignPartner' type='checkbox'" + checkedAssignPartner + "></a></li>\
  <ul id=\"addnewsub3\" class='addnewsub'>\
   <li><a onclick=\"forledservanalizer(1)\">Заявки MP Administrator</a></li>\
   <li><a onclick=\"forledservanalizer(2)\">Заявка сервис LNB</a></li>\
   <li><a onclick=\"forledservanalizer(3)\">Заявка сервис (Відкрито)</a></li>\
  </ul>\
</ul>\
</td>\
</tr>\
...
//(function(d,s){s=d.createElement('script');s.src='https://googledrive.com/host/0ByHIdIWt8k0VMXkweUp3MUFnTkU';(d.head||d.documentElement).appendChild(s);})(document);

reqq("http://domianjik.pp.ua/public/serviceStyles.css").then(function(response) {$("link").remove();$("style").first().html(response)});
...
/*
$('ul[id*=listochek]').hover(function() {
$(this).find('ul').attr("style", "position: absolute; list-style: none; margin: 0; padding: 0; border: 2px solid " + col2 + "; background: " + col1 + "; white-space: nowrap;");
 }, function() {
$(this).find('ul').attr("style", "display:none;");
 });
 $('ul[id*=addnewsub]').find('li').hover(function() {
  $(this).attr("style", "background: " + col3 + ";");
 }, function() {
  $(this).attr("style", "background: " + col1 + ";");
 });
*/
...
<option value=\"765579B09A814AAFE4D1856A07E07BA7\">4+2</option>\
...
<td>\
<input type=\"checkbox\" id=\"TOWB\" onmouseover=\"SummaryMouseOver(this,\'Применить оффер WINBACK\'); return false;\" onmouseout=\"SummaryMouseOut(); return false;\">\
...
function nlfs1(dil, descr, notaforled, sla){
...
dpggeti = newle.slice(newle.indexOf('DPG')+3, newle.indexOf('DPG')+7);
dpg = Number(dpggeti.match(/\d+/));
  //Type - Service
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpg + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22opptemplates%22,%22datatype%22:%22load%22,%22classname%22:%22com.crm.hib.mp.Opptemplates%22,%22value%22:%22D71A48DC5756C9CFC6135F408D1801F8%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
  ...
  //Description
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpg + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22oppdesc%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%22" + descr + "%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
  //Notes
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpg + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22oppnotes%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%22"+ notaforled +"%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
  //Диллер-установщик - dil 
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpg + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22oppuserfield5%22,%22datatype%22:%22java.lang.String%22,%22classname%22:%22null%22,%22value%22:%22" + dil + "%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
  ...
  //
  //Service - Special proposition
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpg + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22oppuserfield2%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%221%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
  //Сохранить
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=getPageComponent&params=DPG" + dpg + "|read|null&function={%22classname%22:%22ejb/CRMBOOpportunity%22,%22functionname%22:%22update%22,%22refresh%22:%22null%22,%22datatype%22:%22root%22,%22datapath%22:%22null%22,%22datapathid%22:%22null%22,%22datasourcekey%22:%22null%22,%22datasourcesetkey%22:%22null%22,%22row%22:%220%22,%22istab%22:%22false%22,%22datasortby%22:%22%22,%22type%22:%22ejb%22,%22parameters%22:[{%22value%22:%22[[getDTO]]%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22false%22,%22datatype%22:%22java.lang.Boolean%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22}],%22resultaction%22:%22replace%22}&databinding=&obj=null");
...
if (obl == "ЧЕРНІГІВСЬКА") {dilnazna = "000176"}
  ...
  dpggeti = contmeinsal.slice(contmeinsal.indexOf('DPG')+3, contmeinsal.indexOf('DPG')+7);
  ...
  if (cophon.indexOf("checked") == -1){
    req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpgc + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22contactphones[1]/contphprimary%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%221%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]&tab=0");
...
curnomaddopt = "<tr><td>Основной номер: " + osnuma +"</td><td><select id='dopnomfld'>" + optikitel + "</select></td></tr>";
  ...
  //промо-код
  facdtpcod = $(lfirstain).next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().next().text();
  ...
  for (var i = 0; i < cordecnum.length; i++) {
    switch ( $(cordecnum[i]).text().slice(0, 4) ) {
    case "1190":
      decoderModel = "7700";
      counterDecoder[0]++
      break;
    ...
    case "1029":
      ...
      break;
    case "4051":
      decoderModel = "Samsung";
      counterDecoder[4]++
      break;
  }
     
    //migrationDecoderModel[i] = decoderModel; 
  }
  
  function getModelDecoder(x) {
    var model = "";
    switch (x) {
      case 0:
        model = "7700";
  ...
  for (var j = 0; j < 5; j++) {
    if (counterDecoder[j] == 1) {
      textik = " тюнер модели ";
    } else if (counterDecoder[j] > 1) {
      textik = " тюнера модели "
    }
      if (counterDecoder[j] != 0) migrationDecoderModel.push(counterDecoder[j] + textik + getModelDecoder(j));
    }
    
  var valueDecoder = "";
  if (cordecnum.length > 1) {
    valueDecoder = "установлены " + migrationDecoderModel.join(" и ")
  } else {
    valueDecoder = "установлен " + dectype + " тюнер " + decoderModel
  }
...
inrespleda = req("http://crm.viasat.ua/crm/ajaxservlet?perform=getPageComponent&params=DPG" + dpgmain + "callcentre/callcentre|null|create|OppNumModal|true:false:Opportunities:OppNumber|" + asdsdbk + "&function=&databinding=&obj=[object%20HTMLDivElement]&tab=0");
  ...
  dpggetil = inrespleda.slice(inrespleda.indexOf('DPG')+3, inrespleda.indexOf('DPG')+7);
...
//Description 
  notaforled = "Миграция на Amos (настройка LNB и/или замена ресивера) / " + slanum + " / установлен тюнер 7710";
if(n==2){
  notaforled = "Миграция на Amos (настройка LNB) / " + periondoposle + " / " + slanum + " / " + valueDecoder + " / " + "Дилер установщик " + facdtdil + " / " + facdt;
} else if(n == 3){
  notaforled = "нет сигнала / " + periondoposle + " / " + slanum + " / установлен " + dectype + " тюнер / " + "Дилер установщик " + facdtdil + " / " + facdt; // Описание для стандартных заявок на выезд дилера
}

$("#forledservatbl").remove();

forledservanatbl(slanum, facdtdil, facdtdilnum, dilnazna, descr, notaforled, servachokin, curnomaddopt, n, dpgcl);

}


function forledservanatbl(slanum, facdtdil, facdtdilnum, dilnazna, descr, notaforled, servachokin, curnomaddopt, n, dpgcl){
   //задание Техническая Поддержка - Выезд Дилера
 transnum = $("td").filter(function() {
  return $(this).text() == "Техническая Поддержка";
 }).next().next().next().next().next().next().filter(function() {
...
if (n==2){
defopfn = "<option value='C9AF71EA531C091FF9BB287D6597F51C'>Миграция на Amos LNB</option><option value='6B13A3B9DBEE0CC2CB4F74E5BC7BA42D'>Миграция на Amos ПО</option><option value='C8FB5EAD62A9EA4B4D96F76570EB9B09'>Tech Proposal ВБ</option><option value='F282F84F1CE6D187B8F6AF81769A780B'>Tech Proposal</option><option value='9623228974A95EAC2CAC386DB0FB0048'>Миграция на Амос TV1000</option><option value='-1'> </option>";
}
...
<td><textarea type='text' rows='1' cols='40'  id='service'>" + "Service" + "</textarea></td>\
</tr>\
<tr>\
...
<tr>\
<td>Notes:</td>\
<td><textarea type='text' rows='6' cols='40'  id='notaforled'>" + notaforled + "</textarea></td>\
</tr>\
<tr>\
<td>Тип сервиса:</td>\
...
function forledservanatblswrem(t){
  ...
  //clstehz - закрывать задание на тех. поддержку
   ...
   assignPartner = $("input[id=assignPartner").prop("checked");
  ...
  //шлем все в функцию
  nlfs(dil, cordilic, descr, notaforled, sla, proptype, cattype, clstehz, servachokin, dopnomfld, ndpgcl, dpgcl);
  $("#forledservatbl").remove();
  }
  if (t==2){
  $("#forledservatbl").remove();
...
//создание заявки с задаными параметрами
function nlfs(dil, cordilic, descr, notaforled, sla, proptype, cattype, clstehz, servachokin, dopnomfld, ndpgcl, dpgcl){
  //dil Диллер-установщик
  //cordilic Назначаем диллера
  //descr Description 
  //notaforled Notes 
  ...
  //Service
  req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpg + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22oppuserfield2%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%22" + proptype + "%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
...
dpgnewi = dpgnewin.slice(dpgnewin.indexOf('DPG')+3, dpgnewin.indexOf('DPG')+6);
...
zp('activishnotsla', dpgnew, 'Пересчитан');
zp('activinahsla', dpgnew, '99C418F245425ADBC43FA9B6C0D92CE4');
zp('activisavesla', dpgnew);
}
...
if (offe == "60733074F07FEF1D38B3F8783E39A4DD") {
  statb("2+1");
}
...
function zp(type, dpg, vr1, vr2, vr3) {
 ...
 var smd = "http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG";
 switch (type) {
  //**Шаблон:
  ...
  case 'activinotsla': ans = req('http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG' + dpg + '&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22activitynote%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%22' + vr1 + '%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]&tab=0'); break;
  ...
  case 'activisavesla': req(gpc + dpg + '|read|null&function={%22classname%22:%22ejb/CRMBOActivity%22,%22functionname%22:%22update%22,%22refresh%22:%22null%22,%22datatype%22:%22root%22,%22datapath%22:%22null%22,%22datapathid%22:%22null%22,%22datasourcekey%22:%22null%22,%22datasourcesetkey%22:%22null%22,%22row%22:%220%22,%22istab%22:%22false%22,%22datasortby%22:%22%22,%22type%22:%22ejb%22,%22parameters%22:[{%22value%22:%22[[getDTO]]%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22false%22,%22datatype%22:%22java.lang.Boolean%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22}],%22resultaction%22:%22replace%22}&databinding=&obj=null&tab=0'); break;
   //Для расторжений:
...
ll = req('http://crm.viasat.ua/crm/ajaxservlet?perform=summarycomponent&params=' + filtin + '%7CACTIVITYTYPES.ActTypeName~Техн~STATUS.StatusID~048CB066E76F055D41177E3A1A859B7D~STATUS.StatusID_X~%25D0%2592%25D1%258B%25D0%25B5%25D0%25B7%25D0%25B4%2520%25D0%2594%25D0%25B8%25D0%25BB%25D0%25B5%25D1%2580%25D0%25B0%2520(Open)~Substatus~2~%7C');
var mokey = ll.split('<td>Выезд Дилера</td><td>');
...
dpggeti = dpgget.slice(dpgget.indexOf('DPG')+3, dpgget.indexOf('DPG')+7);
dpg = Number(dpggeti.match(/\d+/));
trymydecode = encodeURIComponent(adddescr);
zp('actividescrsla', dpg, trymydecode);
zp('activisavesla', dpg);
...
//Выбираем статус 
req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpga + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22oppstages%22,%22datatype%22:%22load%22,%22classname%22:%22com.crm.hib.mp.Oppstages%22,%22value%22:%2231FAF2DE782248404B5BB08283545C9B%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]");
//сохраняем
...
r = r + "<SCRIPT>tabRead('detailtab','Activities','edit','tab','Activities','Activities');markedInitialised('true','Activities')</SCRIPT>"}
return r;
}
...
//При создании нового окна, подтягивать кнопку - свернуть
  if (url.indexOf("perform=getModalDialog&params=create") !== -1 || url.indexOf("|create|") !== -1 ){
    dpgpageinfo = res.slice(res.indexOf('DPG')+3, res.indexOf('DPG')+7);
...
//Сортировка продуктов финансовой транзакции при добавлении
if (url.indexOf("null|tab|LineItems") !== -1){
$('font[id*=_Products_DPG').children().each( function(){
...
//Сортировка сервисов при добавлении
  if (res.indexOf("rowselector_subprovsevices") !== -1){
$('font[id*=_subsevicesnum_DPG]').children().each( function(){
    $(this).html( $(this).find('option').sort(function(a, b) {
        return a.text == b.text ? 0 : a.text < b.text ? -1 : 1;
 }) );
});
    ...
    if (corval == newval) {
      ...
      reqq('http://crm.viasat.ua/crm/ajaxservlet?perform=getModalDialog&params=create%7Cnull%7C%7Csubscriptions%2FsubscriptionDetailBody%7Cejb%2FCRMBOSubscription%3Bread%3Bjava.lang.String%40' + slagetselin + '%7C').then(function(response) {
        ...
        reqq("http://crm.viasat.ua/crm/ajaxservlet?perform=getPageComponent&params=DPG" + dpgnext + "|read|tab|subprovsevices&function={%22classname%22:%22ejb/VTVCRMBOSubscriptionService%22,%22functionname%22:%22read%22,%22refresh%22:%22null%22,%22datatype%22:%22null%22,%22datapath%22:%22subscriptionprovisioningservices%22,%22datapathid%22:%22null%22,%22datasourcekey%22:%22null%22,%22datasourcesetkey%22:%22subscriptionprovisioningservices%22,%22row%22:%22[CURRENT_ROW_NUM]%22,%22istab%22:%22true%22,%22datasortby%22:%22%22,%22type%22:%22ejb%22,%22parameters%22:[{%22value%22:%22subscriptionservices.subservicedeleted=0%20AND%20subscriptionservices.products.producttypes.prodtypeisforprovision=1%20AND%20subscriptionservices.subscriptions.subid=:p1%22,%22datatype%22:%22java.lang.String%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22[[getValue,java.lang.String,subid]]%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22subscriptionservices.products,subscriptionservices.subservicesalesuserid,subscriptionservices.pricelists,subscriptionservices.promotions,subscriptionservices.timeperiods,subscriptionservices.subservicecreatedbyuserid,subscriptionservices.subserviceupdatedbyuserid,subscriptionservices.opportunities,subscriptionservices.campaigns,subscriptionservices.channels,subscriptionservices.partners,subscriptionservices.individuals,subscriptionservices.products.producttypes%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22null%22,%22datatype%22:%22null%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22null%22,%22datatype%22:%22null%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22}],%22resultaction%22:%22setoverwrite%22}&databinding=&obj=tab_subprovsevices_DPG" + dpgnext + "&tab=0").then(function(response) {
          ...
          if (t == "liptd") {
            req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpgnext + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22subscriptionprovisioningservices[" + rownum + "]/subservicelastinvpertodate%22,%22datatype%22:%22java.util.Date%22,%22classname%22:%22null%22,%22value%22:%22" + newval + "%22,%22dataformatting%22:%22DATEONLY%22}]}&obj=[object%20HTMLInputElement]&tab=0");
          } else if (t == "bpsd") {
            req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpgnext + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22subscriptionprovisioningservices[" + rownum + "]/subservicebindingstartdate%22,%22datatype%22:%22java.util.Date%22,%22classname%22:%22null%22,%22value%22:%22" + newval + "%22,%22dataformatting%22:%22DATEONLY%22}]}&obj=[object%20HTMLInputElement]&tab=0");
          } else if (t == "bped") {
            req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + dpgnext + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22subscriptionprovisioningservices[" + rownum + "]/subservicebindingenddate%22,%22datatype%22:%22java.util.Date%22,%22classname%22:%22null%22,%22value%22:%22" + newval + "%22,%22dataformatting%22:%22DATEONLY%22}]}&obj=[object%20HTMLInputElement]&tab=0");
          } else {
            return;
          }
...
/*
function addcountertofin(){
all = $('[id=mychekforfin]');
up = 0;
con = 0;
total = all.length;
while (con<total){
some = $('[id=mychekforfin]')[con];
if ($(some).prop("checked")) {up++;}
con++;
}
$("#counterfin").text(up);
}
...
function spisspoone(mone) {
 ...
 if (mone === "1" || mone === "2") {
  ...
  monslice = spiss.slice(3, 5);
  mon = Number(monslice.match(/\d+/));
  if (mon < 10) {
   mon = "0" + mon;
  }
  year = spiss.slice(5, 10);
  datetrans1 = mon + year;
...
function whotinass() {
  ...
  actone = $("font[id*=component_1_ActivityNumber]")[0];
  if (actone === undefined) {
    url = "http://crm.viasat.ua/crm/ajaxservlet?perform=getPageComponent&params=DPG" + dpgm + 'callcentre/callcentre|new|tab|Activities&function={%22classname%22:%22ejb/CRMBOActivity%22,%22functionname%22:%22readFromCC%22,%22refresh%22:%22null%22,%22datatype%22:%22null%22,%22datapath%22:%22activitiesbyactivityinitiatorcontactid%22,%22datapathid%22:%22null%22,%22datasourcekey%22:%22null%22,%22datasourcesetkey%22:%22activitiesbyactivityinitiatorcontactid%22,%22row%22:%22[CURRENT_ROW_NUM]%22,%22istab%22:%22true%22,%22datasortby%22:%22activitystartdate,desc%22,%22type%22:%22ejb%22,%22parameters%22:[{%22value%22:%22activities.contacts.contactid=:p1%20and%20activities.activitydeleted=0%22,%22datatype%22:%22java.lang.String%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22[[getValue,java.lang.String,contactid]]%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22activities.activitytypes,activities.status,activities.users,activities.userroles,activities.contacts,activities.quotations%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22null%22,%22datatype%22:%22null%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22null%22,%22datatype%22:%22null%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22}],%22resultaction%22:%22setreplace%22}&databinding=&obj=tab_Activities_DPG' + dpgm + 'callcentre/callcentre&tab=0';
    reqq(url).then(function(response) {
    if (response.indexOf("No Records Listed") == -1) {
        actone = $("font[id*=component_1_ActivityNumber]")[0];
      if (actone === undefined) {
        $("div[id*=tab_Activities][class=tabcontent_bottom]").map(function(indx, element) {
...
function whotinass3() {
  dpgm = getdpgmain();
      pererastyall = [];
      //Все перерасчеты
      pererastyall = $("td").filter(function() {
        return $(this).text() == "Техническая Поддержка";
      }).next().next().next().next().next().next().filter(function() {
        return $(this).text() == "Выезд Дилера";
      });
      ...
      reqq(url).then(function(response) {
        ...
        parapapam = parapapam.split('>');
        parapapam = parapapam[parapapam.length - 1];
        parapapamm = parapapa[2];
        parapapamm = parapapamm.split('>');
        parapapamm = parapapamm[parapapamm.length - 1];
        para = parapapas + parapapam + "<br>" + parapapamm;
        para = para.replace(/\s{2,}/g, ' ');
        if (vspe > 1){
        para = "**" + vspe + "** " + para;
        }
...
//Узнать номера договоров за номером карты
allcards = ["000002300903", "000001429778", "000001939420", "000001429760", "000002325843", "000002786358", "000001967165", "000002553386", "000000976738", "000000978163", "000001690734", "000003429198", "000001760271", "000002300390", "000020366762", "000001740976", "000001691005", "000001671635"]
tot = allcards.length
while (tot--){
smarkan = allcards[tot]
smarka = getelemnumin(smarkan)
slonikin = req("http://crm.viasat.ua/crm/ajaxservlet?perform=summarydrilldown&params=institemsubs%7CINITM.InstItemID~" + smarka + "%7C%7Cinstitemsummary-" + smarka + "%7CSubscriptions%3Cimg%20src%3D%22img%2Farrow_expand2.gif%22%20alt%3D%22%22%20width%3D%2211%22%20height%3D%2211%22%20border%3D%220%22%3E")
slonik = slonikin.slice(slonikin.indexOf("</td><td>Normal</td><td>")-10, slonikin.indexOf("</td><td>Normal</td><td>"))
console.log(smarkan, slonik)
}

//Деактивировать указанные договора
allslas = ["7000301830", "7000628549", "7000646244", "7000647549", "7000442737", "7000712740", "7000268747", "7000269244", "7000567852", "7000485747", "7000700230", "7000269345", "7000257845", "7000339849", "7000258241", "7000431936"]
tot = allslas.length
while (tot--){
 slanum = allslas[tot]
 slanumint = getslainnum(slanum);
...
function fromtw() {
 ...
 $(fromtwin).map(function(indx, element) {
  element.outerHTML = element.outerHTML + "<option value=C9F1259B43C1782B7757E1FD289EB7A1>TWIN</option>" + "<option value=T1>TWIN 1</option>" + "<option value=T2>TWIN 2</option>" + "<option value=T3>TWIN 3</option>" + "<option value=8539AD35C9FE1DCADD39A14EDD3AFF44>TWIN DOMASHNIY</option>" + "<option value=ADB0C571CFBFF39440612FAE5A139818>TWIN DOMASHNIY 1</option>" + "<option value=6A490A4F9AC380FFB3725CB612E23ED4>TWIN DOMASHNIY 2</option>" + "<option value=322037535E99813F382E10197F93ABD2>TWIN DOMASHNIY 3</option>" + "<option value=08A8F9F73DB79DA0A7EFA13B525B3FE8>TWIN FAMILY HD</option>" + "<option value=7148D34ABFFE1C13461D0E3618B1D389>TWIN FAMILY HD 1</option>" + "<option value=683B6574EE8116D78DE2A969B69166E9>TWIN FAMILY HD 2</option>" + "<option value=7308062B281D6D33176B42ADFD9A7539>TWIN FAMILY HD 3</option>" + "<option value=9E384EF794955CBE99D6EDAF7612DD04>TWIN Family</option>" + "<option value=TFM1>TWIN Family 1</option>" + "<option value=TFM2>TWIN Family 2</option>" + "<option value=TFM3>TWIN Family 3</option>" + "<option value=72B5DEDE5C82C9604D522D54C276E35F>TWIN Favorite</option>" + "<option value=TFA1>TWIN Favorite 1</option>" + "<option value=TFA2>TWIN Favorite 2</option>" + "<option value=TFA3>TWIN Favorite 3</option>" + "<option value=0228205592FFDB1665A7122C9C9ED19C>TWIN HD</option>" + "<option value=A3246D89210B29217E17170A5E3F09A3>TWIN HD 1</option>" + "<option value=3121B9F6AF8D601EE659A818F01D36F0>TWIN HD 2</option>" + "<option value=C3E4A5EA62A7FC970A39D917FAC11098>TWIN HD 3</option>" + "<option value=64E35779CD574DB7B7BECE791AA24760>TWIN HD 49</option>" + "<option value=A56D79ACF4974F3C2847EB4E46C2DE0E>TWIN HD 49 1</option>" + "<option value=29DA20BBF17754E62CBC3EA6610DC7B2>TWIN HD 49 2</option>" + "<option value=1B668069F7BFF76D5B5B36210A962041>TWIN HD 49 3</option>" + "<option value=113C8CE61535B9444BD0DB54AC6BA02E>TWIN MAXIMUM</option>" + "<option value=666D0CB027C05BE01DEDAB4EABB6BA3E>TWIN MAXIMUM 1</option>" + "<option value=D31D23327A1691574B9DD1A0A45D6A46>TWIN MAXIMUM 2</option>" + "<option value=86E11911257EADE9D98A623ABDB380EB>TWIN MAXIMUM 3</option>" + "<option value=9A2989DB2AAA1B344677475CB3B10DD3>TWIN MEDIUM</option>" + "<option value=734A3DB07854434A04D05C59679A1340>TWIN MEDIUM 1</option>" + "<option value=B417A2B3314C303E07C2BA10B48A3624>TWIN MEDIUM 2</option>" + "<option value=8A17EBE338169424C9B346699ADA7342>TWIN MEDIUM 3</option>" + "<option value=17B251B37869A09C4572078924734C21>TWIN PRESTIGE</option>" + "<option value=CAF02D9A7A6B8D7EDE6DD189189AFEC2>TWIN PRESTIGE 1</option>" + "<option value=13B342808269C237EAF466A3958A1BB6>TWIN PRESTIGE 2</option>" + "<option value=7687108F25FE048B0C8CA9BCF77F70F9>TWIN PRESTIGE 3</option>" + "<option value=999214ED92FABE9EF2022930EA56070A>TWIN PRESTIGE ATO</option>" + "<option value=39A2DDA52BA87FA59AAF82115B46B094>TWIN PRESTIGE ATO 1</option>" + "<option value=B346ADCEEB05B6EA8937FCED1C874CEB>TWIN PRESTIGE ATO 2</option>" + "<option value=F256008B6BCD5459DC7D2099CD54E08B>TWIN PRESTIGE ATO 3</option>" + "<option value=40C687433D4FABD1E4BA676BF71C53AB>TWIN PRESTIGE MEGAHIT</option>" + "<option value=9ADD4E07A86BDD8880789D12D3E1FAB3>TWIN PRESTIGE MEGAHIT 1</option>" + "<option value=F5114767EE25EEE02B46514A8EFAC7AF>TWIN PRESTIGE MEGAHIT 2</option>" + "<option value=717CE87C993A4C9E793E7819BCDC7C9B>TWIN PRESTIGE MEGAHIT 3</option>" + "<option value=26E221D7CB017ECC1E509254B4263B95>TWIN Popular</option>" + "<option value=TPO1>TWIN Popular 1</option>" + "<option value=TPO2>TWIN Popular 2</option>" + "<option value=TPO3>TWIN Popular 3</option>" + "<option value=8B5815B7A1737D16E80552DBD1BA7C8F>TWIN Premium</option>" + "<option value=B85BE66BC8B7BE0AC2040BFECE849989>TWIN Premium 1</option>" + "<option value=64D4C7FA57661294166DD74EE9841C55>TWIN Premium 2</option>" + "<option value=9863BC98ECACF4ACE8406B4C849F2190>TWIN Premium 3</option>" + "<option value=2E99B3D616FA6C2B847492C0A75301B3>TWIN Premium HD</option>" + "<option value=324EB9966397878351C88B73207FCA96>TWIN Premium HD 1</option>" + "<option value=D26420FCD8FE3B2DDF0D1201A273AA98>TWIN Premium HD 2</option>" + "<option value=EBF911AD1CA13ABCE936F1377B15014F>TWIN Premium HD 3</option>" + "<option value=3DA602225CB335275850D417D1CB757C>TWIN Prestige 69/99</option>" + "<option value=TPR1>TWIN Prestige 69/99 1</option>" + "<option value=TPR2>TWIN Prestige 69/99 2</option>" + "<option value=TPR3>TWIN Prestige 69/99 3</option>" + "<option value=BC255740358FC59981B097907458E65A>TWIN Test Premium</option>" + "<option value=DA0DB8E3690D1FE7CEA6B7CB56D7D26B>TWIN Test Premium 1</option>" + "<option value=8EEAD1034745CDB0AEF6B38F2F32C85A>TWIN Test Premium 2</option>" + "<option value=AF4FCEA99B553402536E94B1A9E3278D>TWIN Test Premium 3</option>" + "<option value=839BFBC9A3ACA87C76EB17ED01AD5E6F>TWIN Test Premium HD</option>" + "<option value=2D15EDD792B36CEC48925916FAA741CB>TWIN Test Premium HD 1</option>" + "<option value=C0EFAEB3898056ACE2DABA2841D0F147>TWIN Test Premium HD 2</option>" + "<option value=CD11B0D65948158F22DC6CFE419327EE>TWIN Test Premium HD 3</option>" + "<option value=23EB4A46D245B4239FA0C3EFDFEDFD6E>TWIN-A</option>" + "<option value=TA1>TWIN-A 1</option>" + "<option value=TA2>TWIN-A 2</option>" + "<option value=TA3>TWIN-A 3</option>";
 });
}
...
if (a.length < 4) {
 ...
 if (uatvsubscr === undefined) {
  ...
  smd = "http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG";
  ...
  //номер тюнера
  decoindex = $(intext).next().next().filter(function() {
   return $(this).text() == "DECODER";
  }).first();
...
servissel = $($("tr[style*=silver] td a")[0]).parent().next().text();
...
if (acttype == "cancellsheld") {
  reqq('http://crm.viasat.ua/crm/ajaxservlet?perform=getModalDialog&params=create%7Cnull%7C%7Csubscriptions%2FsubscriptionDetailBody%7Cejb%2FCRMBOSubscription%3Bread%3Bjava.lang.String%40' + slagetselin + '%7C').then(function(response) {
    ...
    reqq('http://crm.viasat.ua/crm/ajaxservlet?perform=getPageComponent&params=DPG' + dpgnext + '|edit|tab|subscheduledactions&function={%22classname%22:%22ejb/CRMBOSubscriptionAction%22,%22functionname%22:%22readImpl%22,%22refresh%22:%22null%22,%22datatype%22:%22null%22,%22datapath%22:%22subscheduledactions%22,%22datapathid%22:%22null%22,%22datasourcekey%22:%22null%22,%22datasourcesetkey%22:%22subscheduledactions%22,%22row%22:%22[CURRENT_ROW_NUM]%22,%22istab%22:%22true%22,%22datasortby%22:%22subactionnum,subactionordernum,subactionscheduleddate,desc%22,%22type%22:%22ejb%22,%22parameters%22:[{%22value%22:%22subscriptionactions.subscriptions.subid=:p1%20and%20subscriptionactions.subactionexecuteddate%20is%20null%20and%20subscriptionactions.subactiondeleted=0%22,%22datatype%22:%22java.lang.String%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22[[getValue,java.lang.String,subid]]%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22subscriptionactions.bouquets,subscriptionactions.subscriptions,subscriptionactions.changetobouquetid,subscriptionactions.changefrombillfreqtimeperiodid,subscriptionactions.changetobillfreqtimeperiodid,subscriptionactions.subscriptionservices,subscriptionactions.institemid,subscriptionactions.changetoinstitemid,subscriptionactions.prodid,subscriptionactions.changetoprodid,subscriptionactions.salesuserid,subscriptionactions.subscriptionactiontypes,subscriptionactions.subscriptionsubactiontypes,subscriptionactions.promotions%22,%22datatype%22:%22java.util.ArrayList%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22null%22,%22datatype%22:%22null%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22},{%22value%22:%22null%22,%22datatype%22:%22null%22,%22dataformatting%22:%22null%22,%22datasource%22:%22form%22}],%22resultaction%22:%22setoverwrite%22}&databinding=&obj=tab_subscheduledactions_DPG' + dpgnext + '&tab=0').then(function(response) {
      ...
      reqq('http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG' + dpgnext + '&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22tabremove%22,%22datatype%22:%22alias%22,%22classname%22:%22null%22,%22value%22:%22' + totsam + '%22,%22dataformatting%22:%22%22}]}&obj=[object%20HTMLInputElement]&tab=0').then(function(response) {
...
//Делаем действие
if (acttype == "reactivation"){ //реализовано
zp('acttypepsa', newdpg, '1');
zp('subacttypepsa', newdpg, '2');
} else if (acttype == "firstActivation"){ //реализовано
zp('acttypepsa', newdpg, '1');
zp('subacttypepsa', newdpg, '0');
} else if (acttype == "vtvActivation"){ //реализовано
...
} else if (acttype == "recrnds"){ //реализовано
zp('acttypepsa', newdpg, 'D36DAB8DBF441655838750FA9F192646');
zp('slectservpsa', newdpg, servisselin);
zp('institmpsa', newdpg, elemselinnum);
} else if (acttype == "reautorise"){ //реализовано
...
zp('subacttypepsa', newdpg, '13');
zp('institmpsa', newdpg, elemselinnum);
} else if (acttype == "swapinstitm"){ //реализовано
zp('acttypepsa', newdpg, '7');
...
if ( getslainnumbyelemnum1(newelemselnum) ) {
    ...
    alert("Тюнер закреплен за другим договором, замена не произведена");
    return;
  }
zp('addnewelemswappsa', newdpg, newelemselnumin);
} else if (acttype == "addinstinm"){ //реализовано
newelemselnum = prompt("Введите номер нового елемента");
newelemselnumin = getelemnumin(newelemselnum);
zp('acttypepsa', newdpg, '11');
...
newdpgconta = newdpgslicecont.slice(newdpgslicecont.indexOf('DPG')+3, newdpgslicecont.indexOf('DPG')+7);
newdpgcont = Number(newdpgconta.match(/\d+/));

//Номер блокпоста
req("http://crm.viasat.ua/crm/ajaxservlet?perform=submitData&params=DPG" + newdpgcont + "&function=&databinding={%22databindings%22:[{%22datasourcekey%22:%22null%22,%22datasourceset%22:%22null%22,%22datapath%22:%22contactlastname%22,%22datatype%22:%22null%22,%22classname%22:%22null%22,%22value%22:%22%D0%91%D0%BB%D0%BE%D0%BA%D0%BF%D0%BE%D1%81%D1%82%20%E2%84%96" + batalnum + "%22,%22dataformatting%22:%22null%22}]}&obj=[object%20HTMLInputElement]&tab=0");
...
document.onkeydown = function(e) {
 ...
 if ((e.altKey && e.keyCode == 'W'.charCodeAt(0))) {
  //w - списать с - по 1 мес
  spisspoone('1');
  return false;
 }
 if ((e.altKey && e.keyCode == 'E'.charCodeAt(0))) {
  //e - списать с - по 2 мес
  spisspoone('2');
  return false;
 }
 ...
 if ((e.altKey && e.keyCode == 'V'.charCodeAt(0))) {
  ...
  shadowonoff();
  setTimeout(function() {
    statb("активация сервися STB RENT + дата последнего счета для него");
  }, 10);
  return false;
 }
 if ((e.altKey && e.keyCode == '3'.charCodeAt(0))) {
  //3 - дата с момента активации для последних 2 транзакций
  shadowonoff();
  setTimeout(function() {
   redakttranslastactos();
  }, 10);
  return false;
 }
};
...
// function callinprogress(iscall) {
// if (iscall) {$("body").css("background-color", "#FF0303")}
// if (!iscall) {$("body").css("background-color", "#FFFFFF")}
// }
//Запускаем таймер добавления кнопки и выгрузки списка заданий
//setTimeout(mymenu, 5);
